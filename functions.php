...
if ( ! function_exists( 'bayview_setup' ) ) {
    ...
    function bayview_setup() {
		...
		register_default_headers( array(
			'logo' => array(
				'url'           => get_template_directory_uri() . '/assets/img/default-header.png',
				'thumbnail_url' => get_template_directory_uri() . '/assets/img/default-header.png',
				'description'   => __( 'Logo', 'Bayview' )
			)
		) );
		...
		add_theme_support( 'custom-header', array(
			...
			'flex-height'	=> true,
			'height'		=> 450,
			'default-image' => get_template_directory_uri() . '/assets/img/default-header.png',
		) );
